      ...
      <div class="col-md-6">
        <div class="card card-primary">
          ...
          <div class="card-body">
            ...
            echo form_open('data/editkapal/' . $data->id);
            ?>

            <div class="form-group">
              <label>Nama</label>
              <input name="no_kapal" placeholder="Nama" value="<?= $data->no_kapal ?>" class="form-control" />
            </div>

            <div class="form-group">
              <label>Kabupaten</label>
              <input name="pemilik" placeholder="Kabupaten" value="<?= $data->pemilik ?>" class="form-control" />
            </div>
            <div class="form-group">
              <label>TPI</label>
